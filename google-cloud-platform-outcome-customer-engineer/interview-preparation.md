# Google Cloud OCE — Interview Preparation

**Interview:** Thursday, May 21, 2026 — 20-minute Google Meet screen
**Interviewer:** Karina Kaufman, Recruiting Business Partner, EMEA Cloud CE
...
**Context:** *Answering "Tell me about yourself and what's drawing you to this OCE role at Google."*
...
**Context:** *Answering "What are your compensation expectations?" Treat this like a comp conversation with a Deloitte managing partner — direct, numbers-first, no hedging. The earlier 80/20 equity posture is dropped: it would have flagged you as a founder-posture outlier under Syntec and Google's global comp framework. Anchor on TC, signal an RSU lean, and defer the structural mechanics to Google.*
...
### Phase 4: Your Closing Questions (Minutes 17–20)

**Context:** *Karina opens the floor for your questions. Position yourself as a multi-regional leader.*

> "Yes, I have two quick questions from a strategic perspective:
>
> 1. Personally, I am very excited about how Google France operates from a broader territory lens. Given my deep track record managing complex, multi-regional topologies in North America, I'm curious: does this Paris-based OCE team purely focus on local French enterprises, or does the portfolio expand across the wider Francophone and SEMEA cross-border markets like Benelux, Switzerland, or North Africa?
>
> 2. As a Recruiting Business Partner, when you see senior talent from the Big 4 successfully transition into this unique OCE 'player-coach' role at Google, what is the one trait that sets the top performers apart?"

---

## Final Blueprint Review

- **The Tone:** Boardroom-level, progressive, and confident.
- **The Positioning:** You are not an applicant asking for a job; you are an industry peer aligning with Google's forward-looking operating model.
- **The Logistics:** Ensure your name is in the calendar invite per Karina's note, log in 5 minutes early, and let your enterprise delivery maturity shine.
